...
import CountUp from "react-countup"; // es el que permite hacer la animación de los números contando hacia arriba

import { dataCounter } from "@/data"; // de aqui traemos los datos de los contadores
        ...
        <div key={id} className={`${lineRight && 'ltr'}`}>
          <div className={`${lineRight && 'px-4 border-2 border-transparent md:border-e-gray-100'} ${lineRightMobile && 'border-e-gray-100'}`} >
            <p className="flex mb-2 text-2xl font-extrabold md:text-4xl text-secondary">
              + <CountUp end={endCounter} start={0} duration={2} />
            </p>
